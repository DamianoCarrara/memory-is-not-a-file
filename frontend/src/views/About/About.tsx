    ...
    >
      <article>
        ...
        <Container>
          ...
          <p className={classes.intro}>A collection of over 600 thousand slides from all over the world. A never-ending collection ideally linking single life scenes so as to "project" them on an extended tale made of a net of emotions where you can find your own.<br/>Because the true "memory extension" is not measured in GB and it is not about IT.<br/>Memory is not a file.</p>
