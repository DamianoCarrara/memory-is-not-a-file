const dimbox=function(){"use strict";let config={ajaxTemplate:`
        ...
        </figure>`,iframeRatio:"3x2",iframeTemplate:`
        ...
        window.addEventListener("wheel", ev => {
            ...
            if (direction_1 > 1)  {
              ...
              datax = document.querySelectorAll("[data-dimbox]");
              datax.forEach(el=>{
